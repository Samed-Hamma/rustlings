...
pub fn divide(a: i32, b: i32) -> Result<i32, DivisionError> {
    return match b {
        ...
        x if a % b != 0 => Err(DivisionError::NotDivisible(NotDivisibleError{ dividend: a, divisor: b })),
        _ => Ok(a/b)
    }
}
...
mod tests {
    ...
    fn result_with_list() {
        ...
        let x: Result<Vec<_>, Vec<DivisionError>> = Ok(division_results.collect::<Result<_, DivisionError>>().unwrap());
